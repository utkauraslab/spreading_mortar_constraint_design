...
"""
Cutting a video into rgb image sequence.

'./data' directory stores the cutted rgb images frame by frame.
"""
...
def cut_video_into_frames(video_path, output_folder):
    ...
    Args:
        video_path (str): ./spreading_mortar_constraint_design
        output_folder (str): ./spreading_mortar_constraint_design/data
    """
