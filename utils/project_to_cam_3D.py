...
keypoints_2d = torch.load('trowel_tip_keypoints_pred_tracks.pt')  # Shape: (3, 70, 2)
depth_values = torch.load('trowel_tip_keypoints_depth_tensor.pt')  # Shape: (3, 70)
...
torch.save(trajectories_3d, "trowel_tip_keypoints_trajectories_3d.pt")
